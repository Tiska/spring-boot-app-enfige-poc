...
public abstract class ClientDaoCgImplDefault implements IClientDao {
	 ...
	 **/
	public static final TableAlias<demo.persistence.beans.dao.IClientTo> ALIAS = new JDBCTableAlias<demo.persistence.beans.dao.IClientTo>(demo.persistence.beans.dao.IClientTo.class, "CLIENT", "CLIENT");
	/**
			...
			IClientDao.CLIENT_COLUMNS temp = new CLIENT_COLUMNS() {
				...
				public QueryColumn getNomISNULL(){
					if( columnNomISNULL == null ){
						columnNomISNULL = new JDBCQueryColumn((JDBCTableAlias<?>)ALIAS, "nom", _FIELD_NOM, JDBCFunction.ISNULL, java.lang.String.class);
					}
				...
				public QueryColumn getPrenomISNULL(){
					if( columnPrenomISNULL == null ){
						columnPrenomISNULL = new JDBCQueryColumn((JDBCTableAlias<?>)ALIAS, "prenom", _FIELD_PRENOM, JDBCFunction.ISNULL, java.lang.String.class);
					}
	 ...
	 */
	public PersistenceQuery<demo.persistence.beans.dao.IClientTo> newQuery() {
	 ...
	 */
	public PersistenceQuery<demo.persistence.beans.dao.IClientTo> newSubQuery(PersistenceQuery<?> parentQuery) {
		return new PersistenceQueryClientVersion((demo.persistence.beans.dao.impl.cg.ClientDaoCgImpl)this, parentQuery);
	}
	
	private static class PersistenceQueryClientVersion extends JDBCPersistenceQuery<demo.persistence.beans.dao.IClientTo> {
	...
	private JDBCPersistenceQuery<demo.persistence.beans.dao.IClientTo> _cachePersistenceQuery;
	public void clearListCache() {
		if (_cachePersistenceQuery==null) {
			_cachePersistenceQuery = (JDBCPersistenceQuery<demo.persistence.beans.dao.IClientTo>)newQuery();
		}
	 ...
	 */
	public List<demo.persistence.beans.dao.IClientTo> getList() {
